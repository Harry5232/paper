...
##############################################################################
##
##  com.test.t start up script for UN*X
##
##############################################################################
...
# Add default JVM options here. You can also use JAVA_OPTS and COM_TEST_T_OPTS to pass JVM options to this script.
DEFAULT_JVM_OPTS=""
...
eval set -- $DEFAULT_JVM_OPTS $JAVA_OPTS $COM_TEST_T_OPTS -classpath "\"$CLASSPATH\"" com.test.t.TemplateGenerator "$APP_ARGS"
