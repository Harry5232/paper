...
set CLASSPATH=%APP_HOME%\lib\com.test.t-0.0.1-SNAPSHOT.jar;%APP_HOME%\lib\velocity-1.7.jar;%APP_HOME%\lib\groovy-all-2.4.10.jar;%APP_HOME%\lib\h2-1.4.185.jar;%APP_HOME%\lib\javax.mail-1.6.0.jar;%APP_HOME%\lib\commons-collections-3.2.1.jar;%APP_HOME%\lib\commons-lang-2.4.jar;%APP_HOME%\lib\activation-1.1.jar
